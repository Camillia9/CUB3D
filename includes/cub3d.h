...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/15 16:05:17 by camansou          #+#    #+#             */
/*   Updated: 2025/08/15 16:25:32 by camansou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		count_map_elements(t_data *data, int *player_count,
				int *empty_spaces);
...
int			calcul_tex_x(t_ray *ray, t_texture *texture, double start_x,
				double start_y);
int			calculate_tex_y(t_ray *ray, t_data *data, int y,
				t_texture *texture);
